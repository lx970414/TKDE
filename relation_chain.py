...
class RC(object):
    def __init__(self, data_config, pretrain_data, pretrain_data2, pretrain_data3):
        ...
        *********************************************************
        ...
        '''
        if self.alg_type in ['rc']: 
            
            'The first behavior'
            self.ua_embeddings1, self.ia_embeddings1 = self._create_rc_embed3() #The first behavior         
            ...
            'The next behavior'
            self.ua_embeddings2, self.ia_embeddings2 = self._create_rc_embed2(self.ua_embeddings11,self.ia_embeddings11) 
            ...
            'The last behavior'
            self.ua_embeddings3, self.ia_embeddings3 = self._create_rc_embed(self.ua_embeddings22,self.ia_embeddings22) 
    ...
    def create_model_str(self): 
        log_dir = '/' + self.alg_type+'/layers_'+str(self.n_layers)+'/dim_'+str(self.emb_dim) #/Relation Chain/layers_3/dim_64
...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    if args.pretrain == 1:
        ...
        cur_best_pre_0 = 0.
        print('without pretraining.')
    model = RC(data_config=config, pretrain_data=pretrain_data, pretrain_data2=pretrain_data2, pretrain_data3=pretrain_data3) #创建模型类的对象
